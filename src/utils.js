...
export const signature =
  "This comment was automatically written by the [Blocking Issues](https://github.com/Levi-Lesches/blocking-issues) bot, and this PR will be monitored for further progress.";
...
export function getCommentText(blockingIssues, openIssues, brokenIssues) {
  ...
  for (const issue of blockingIssues) {
    ...
    else if (brokenIssues.includes(issue))
      symbol = ":warning: Issue/PR not found";
    result += `- #${issue} ${symbol}\n`;
  }
  result += "----\n";
  result += signature;
